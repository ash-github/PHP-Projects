...
?>
	<div>
		<center><h1><font face="Algerian">EMPLOYEE LOGIN</font></h1>
			<form method="POST">
				...
				<tr align="center">
					<td align="right">
						 <a href="employee_dash.php"><input type="submit" onclick="message()" name="login" value="Login">
					</td>
					<td align="left">
						<a href="index.php"><input type="button" value="Cancel">
					</td>
				</tr>
