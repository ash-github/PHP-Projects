...
<head>
    ...
    <style>
        ...
        * {
        ...
        .section1 {
            margin-top: 100px;
            box-shadow: 0px 18px 36px 0.2px rgba(0, 0, 0, 0.3);
            padding: 60px;
        ...
        .reason {
            box-shadow: 2px 2px 6px 0.1px rgba(102, 132, 252, 0.77);
        }
...
<body background="image/1_bg.webp">
    ...
    <div class="head-form1">
        <h1>ENTER LEAVE DETAIL</h1>
    </div>
    <!---++++++++++++++++++++++++++++++ SECTION START ++++++++++++++++++++++++++++++-->
    <div class="section1 container" data-aos="fade-left">
        <form id="demoForm" method="POST">
            <div class="cf mb2">
                <div class="fl w-100">
                    <div class="fl w-25 pa2">Reason</div>
                    <div class="fl w-75">
                        <textarea class="input-reset ba b--black-20 pa2 mb2 db w-100 reason" name="info"
            ...
            <div class="cf mb2">
                <div class="fl w-100">
                    ...
                    <div class="fl w-50">
                        <input type="date" class="input-reset ba b--black-20 pa2 mb2 db w-100" name="sdate"
            ...
            <div class="cf mb2">
                <div class="fl w-100">
                    ...
                    <div class="fl w-50">
                        <input type="date" class="input-reset ba b--black-20 pa2 mb2 db w-100" name="edate"
                            placeholder="YYYY/MM/DD" />
                    </div>
                </div>
            </div>
            ...
            <div class="cf mb2">
                <div class="fl w-100">
                    ...
                    <div class="fl w-50">
                    <div class="form-group"><input class="ba b--black-20 bg-blue white ph3 pv2 br2" type="submit" name="save" value="Submit"></div>
                    </div>
                </div>
            </div>
        </form>
...
if(isset($_POST['save']))
{
  ...
  $query="insert into leave1(eid,leave_info,start_date,end_date)values('$sid','$l','$sd','$ed')";
