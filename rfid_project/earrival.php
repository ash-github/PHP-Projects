        ...
        <form id="demoForm" method="POST">
            ...
            <div class="cf mb2">
                <div class="fl w-100">
                    ...
                    <div class="fl w-100">
                        <button type="submit" name="search" class="ba b--black-20 bg-blue white ph3 pv2 br2">Search</button>
                    </div>
                </div>
            </div>
        </form>
...
if(isset($_POST['search']))
{
  $sd=$_POST['sdate'];
  $ed=$_POST['edate'];
  $check="select * from arrival where eid='$sid' and date between '$sd' and '$ed'";
  ...
  while($row=mysqli_fetch_array($result))
  {
    ...
    echo "<center><table  class='table-responsive' width='100%'>
    <tr><th>id</th>
    <th>name</th>
    <th>contact</th>
    <th>date</th>
