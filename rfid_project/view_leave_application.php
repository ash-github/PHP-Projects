        ...
        <form id="demoForm" method="POST">
            ...
            <div class="cf mb2">
                <div class="fl w-100">
                    ...
                    <div class="fl w-100">
                        <button type="submit" name="search" class="ba b--black-20 bg-blue white ph3 pv2 br2">Submit</button>
                    </div>
                </div>
            </div>
        </form>
...
if(isset($_POST['search']))
{
  $sd=$_POST['sdate'];
  $ed=$_POST['edate'];
  $check="select * from leave1 where  start_date and end_date between '$sd' and '$ed'";
