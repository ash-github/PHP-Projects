...
<body background="image/1_bg.webp">
    ...
    <div class="head-form1">
        <h1>VIEW EMPLOYEE ARRIVAL DETAILS</h1>
    </div>
    <!---++++++++++++++++++++++++++++++ SECTION START ++++++++++++++++++++++++++++++-->
    <div class="big-container container">
    <div class="section1 container" data-aos="fade-right">
        <form id="demoForm" method="POST">
            <div class="cf mb2">
                <div class="fl w-100">
                    <div class="fl w-25 pa2">Start date</div>
                    <div class="fl w-100">
                        <input type="date" class="input-reset ba b--black-20 pa2 mb2 db w-100" name="sdate"placeholder="YYYY/MM/DD" />
                    </div>
                </div>
            </div>
            ...
            <div class="cf mb2">
                <div class="fl w-100">
                    ...
                    <div class="fl w-100">
                        <input type="date" class="input-reset ba b--black-20 pa2 mb2 db w-100" name="edate" placeholder="YYYY/MM/DD" />
                    </div>
                </div>
            </div>
            ...
            <div class="cf mb2">
                <div class="fl w-100">
                    ...
                    <div class="fl w-100">
                        <button type="submit" class="ba b--black-20 bg-blue white ph3 pv2 br2" name="search">Search</button>
                    </div>
                </div>
            </div>
        </form>
...
if(isset($_POST['search']))
{
  $sd=$_POST['sdate'];
  $ed=$_POST['edate'];
  $check="select * from arrival where  date between '$sd' and '$ed'";
  ...
  while($row=mysqli_fetch_array($result))
  {
    ...
    echo "<center><table  class='table-responsive' width='96%'>
    <tr><th>id</th>
    <th>name</th>
    <th>contact</th>
    <th>date</th>
