        ...
        <div class="main-content">
            ...
            <main>
                ...
                <div class="switch" id="switch">
                   ...
                   <table style="border:1px solid black; color:black; background-color:black;">
                   <tr>
                     <td>Sr. no</td>
                     <td>Date</td>
                   ...
                   <?php 
                   $t1=0;
                   if(count($report_detail)){
                    $c=1;
                    foreach($report_detail as $row){
                        echo "<tr>";
                        echo "<td>".$c."</td>";
                        echo "<td>".$t=$row->expense_date."</td>";
                        echo "<td>".$t=$row->expense_cost."</td>";
                        echo "</tr>";
                        $t1=((int)$t1+(int)$t);
                        $c=$c+1;
                    }
                    echo "<tr><td>Grand Total= ".$t1."</td></tr>";
                   }
                   ?>
                   </table>
