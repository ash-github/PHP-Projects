    ...
    <div class="main-wrapper">
        <div class="main-content">
            ...
            <main>
                ...
                <input type="text" name="name" value="<?php echo $profile->full_name ?>">
                <input type="email" name="email" readonly="true" value="<?php echo $profile->email?>" >
                <input type="text" name="mobile" value="<?php echo $profile->mobile_no ?>">
                <input type="date" name="reg_date" value="<?php echo $profile->reg_date ?>">
